...
class SysAlbum(models.Model):
    ...
    album_name = models.CharField(max_length=100)
    album_cover = models.CharField(max_length=255, blank=True, null=True)
...
class SysAlbumPicture(models.Model):
    ...
    is_wide = models.IntegerField(blank=True, null=True)
    pic_name = models.CharField(max_length=100)
    pic_tag = models.CharField(max_length=255, blank=True, null=True)
    pic_cover = models.CharField(max_length=255)
    pic_size = models.CharField(max_length=255)
    pic_spec = models.CharField(max_length=100)
    pic_cover_big = models.CharField(max_length=255, blank=True, null=True)
    pic_size_big = models.CharField(max_length=255, blank=True, null=True)
    pic_spec_big = models.CharField(max_length=100, blank=True, null=True)
    pic_cover_mid = models.CharField(max_length=255, blank=True, null=True)
    pic_size_mid = models.CharField(max_length=255, blank=True, null=True)
    pic_spec_mid = models.CharField(max_length=100, blank=True, null=True)
    pic_cover_small = models.CharField(max_length=255, blank=True, null=True)
    pic_size_small = models.CharField(max_length=255, blank=True, null=True)
    pic_spec_small = models.CharField(max_length=255, blank=True, null=True)
    pic_cover_micro = models.CharField(max_length=255, blank=True, null=True)
    pic_size_micro = models.CharField(max_length=255, blank=True, null=True)
    pic_spec_micro = models.CharField(max_length=255, blank=True, null=True)
